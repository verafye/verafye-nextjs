...
<section style={{'background':'linear-gradient(180deg,#F8FBFF 0%,#fff 100%)','padding':'4rem 0'}}>
  <div className="container" style={{'maxWidth':'56rem','textAlign':'center'}}>
    ...
    <p className="animate-fade-up delay-200" style={{'fontSize':'clamp(1rem,2vw,1.25rem)','color':'var(--body)','maxWidth':'48rem','margin':'0 auto 2.5rem'}}>Verafye serves banks, PSPs, PayFacs, fintechs, credit unions, and digital banks - connecting fraud, AML, payments, identity, and behavior signals into explainable investigation workflows designed for regulated environments.</p>
    ...
    <div className="grid-3" style={{'maxWidth':'72rem','margin':'0 auto','gap':'1.5rem'}}>
      ...
      <div className="card card-elevated" style={{'padding':'2rem'}}>
        ...
        <div style={{'display':'flex','flexDirection':'column','gap':'0.625rem'}}>
          ...
          <div style={{'display':'flex','gap':'0.625rem','alignItems':'center'}}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1E6FB7" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5"/></svg><span style={{'fontSize':'0.8125rem','color':'var(--body)'}}>Scalable investigation workflows</span></div>
      ...
      <div className="card card-elevated" style={{'padding':'2rem'}}>
        ...
        <p style={{'fontSize':'0.9375rem','color':'var(--body)','marginBottom':'1.5rem','lineHeight':'1.65'}}>Credit unions face the same AML and fraud obligations as larger institutions - without the same internal resources. Verafye delivers investigation intelligence designed for mid-market scale and operational reality.</p>
        <div style={{'display':'flex','flexDirection':'column','gap':'0.625rem'}}>
...
<section className="section-light" style={{'padding':'4rem 0'}}>
  <div className="container">
    ...
    <div className="grid-4" style={{'maxWidth':'64rem','margin':'0 auto'}}>
      ...
      <div className="card" style={{'padding':'1.75rem','textAlign':'center'}}><div className="stat-value" style={{'marginBottom':'0.5rem'}}>100%</div><p style={{'fontSize':'0.8125rem','fontWeight':'500','color':'var(--body)'}}>Connected investigation layer</p></div>
    </div>
...
<section style={{'padding':'4rem 0','background':'var(--bg-tint)','borderTop':'1px solid var(--border)'}}>
  <div className="container" style={{'textAlign':'center','maxWidth':'48rem'}}>
    ...
    <p style={{'fontSize':'clamp(0.875rem,1.5vw,1rem)','color':'var(--muted)','maxWidth':'34rem','margin':'0 auto 2.5rem'}}>Mid-market banks, payment platforms, and fintechs are investing in investigation intelligence ahead of regulatory review cycles. Verafye is built for that transition.</p>
