            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              ...
              */}
              <div className="card" style={{ padding: '2rem' }}>
                ...
                <p style={{ fontSize: '0.875rem', color: 'var(--body)', lineHeight: 1.7 }}>Verafye connects signals from fraud monitoring, transaction monitoring, and payments infrastructure into one connected network view - eliminating the blind spots that form at system boundaries and enabling cross-domain detection for the first time.</p>
              </div>
              <div className="card" style={{ padding: '2rem' }}>
            ...
            {[
              {
                ...
                body: 'Graph-native intelligence gives fraud, AML, and compliance teams a connected view of risk across entities, transactions, and systems - providing a connected picture of financial crime activity that fragmented, siloed monitoring cannot deliver.',
              },
              {
                gradient: 'gradient-bg-2',
