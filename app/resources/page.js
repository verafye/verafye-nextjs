...
const categories = [
  ...
  },
  {
    ...
    description: 'Analysis of evolving regulatory frameworks and how financial institutions can align their financial crime infrastructure with changing expectations.',
  },
];
...
const resources = [
  {
    ...
    tags: ['Infrastructure', 'Modernisation', 'FRAML'],
  },
  {
  ...
  },
  {
    ...
    description: 'Global regulatory frameworks are raising the bar for financial crime monitoring, investigation quality, and cross-domain risk management. This perspective examines the direction of travel across key frameworks and what evolving expectations mean for fraud, AML, and payments infrastructure.',
    gradient: 'gradient-bg-1',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function ResourcesPage() {
  return (
    <>
      ...
      {/* All resources grid */}
      <section className="section-light" style={{ padding: '4rem 0 5rem' }}>
        <div className="container">
