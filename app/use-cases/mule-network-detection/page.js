          ...
          <div style={{ maxWidth: '72rem', margin: '0 auto' }}>
            ...
            <div className="card card-elevated" style={{ padding: '2.5rem', maxWidth: '56rem', margin: '0 auto' }}>
              <p style={{ fontSize: 'clamp(0.9375rem,1.75vw,1.125rem)', color: 'var(--body)', lineHeight: 1.75 }}>
                Detect first-party fraud, synthetic identities, and loan stacking by connecting borrower data, device intelligence, and behavioral signals across multiple lending touchpoints.
              </p>
