...
const navItems = [
  ...
  {
    label: 'Industries',
    href: '/industries/digital-banks',
    children: [
      { href: '/industries/digital-banks',                    label: 'Digital Banks / Neo Banks' },
      { href: '/industries/payment-processors-psps-payfacs',  label: 'PSPs, PayFacs, MSBs & FinTechs' },
      { href: '/industries/credit-unions',                    label: 'Community Banks & Credit Unions' },
...
const mobileNavGroups = [
  ...
  {
    heading: 'Industries',
    headingHref: '/industries/digital-banks',
    items: [
      { href: '/industries/digital-banks',                    label: 'Digital Banks / Neo Banks' },
      { href: '/industries/payment-processors-psps-payfacs',  label: 'PSPs, PayFacs, MSBs & FinTechs' },
      { href: '/industries/credit-unions',                    label: 'Community Banks & Credit Unions' },
