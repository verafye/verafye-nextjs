      ...
      <section style={{ background: 'linear-gradient(180deg,#F8FBFF 0%,#fff 60%,#fff 100%)', overflow: 'hidden', padding: '5rem 0' }}>
        <div className="container">
          <div style={{ maxWidth: '52rem', margin: '0 auto', textAlign: 'center' }}>
            <p className="eyebrow animate-fade-up" style={{ marginBottom: '1.25rem' }}>Solutions - Investigation Intelligence</p>
            ...
            {[
              {
                ...
                body: 'Automatically group related alerts across fraud, AML, and payments into consolidated investigation clusters - reducing noise and surfacing coordinated activity.',
              },
              {
                ...
                body: 'Structure investigations into formal cases with pre-built context, entity profiles, and relationship maps - ready for analyst review from the moment a case is created.',
              },
              {
                ...
                body: 'Guide analysts through structured, consistent investigation steps - with built-in escalation paths, disposition tracking, and audit trails that support traceability and operational readiness.',
              },
              {
                ...
                title: 'Cross-System Context Aggregation',
                body: 'Pull fraud, AML, and payments signals into a single investigation view - eliminating manual context gathering and giving analysts the full picture without switching platforms.',
              },
              {
                ...
                body: 'Continuously score and rank cases using network risk, relationship context, and cross-system signals - ensuring the highest-impact investigations always surface first.',
              },
              {
                ...
                body: 'Surface the right context at the right moment - risk scores, prior case history, entity relationships, and network indicators - to support faster, higher-confidence analyst decisions.',
              },
            ].map(item => (
      ...
      <section style={{ padding: '5rem 0', background: 'var(--bg-tint)', borderTop: '1px solid var(--border)' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: '48rem' }}>
          <h2 style={{ fontSize: 'clamp(1.5rem,4vw,2.75rem)', fontWeight: 700, color: 'var(--dark)', letterSpacing: '-0.025em', marginBottom: '1.25rem' }}>
            See Investigation Intelligence in Action
          </h2>
