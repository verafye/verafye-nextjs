...
export const metadata = {
  ...
  description: 'Collaborate with Verafye to bring modern financial crime intelligence infrastructure to banks, payment platforms, and fintech ecosystems globally.',
  openGraph: {
    title: 'Partners — Verafye',
    description: 'We work with strategic partners, system integrators, and ecosystem players to deliver scalable fraud, risk, and AML intelligence solutions.',
  },
  twitter: {
        ...
        <div className="container">
          <div style={{ maxWidth: '52rem', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div className="animate-fade-up delay-400" style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', justifyContent: 'center' }}>
              ...
              <Link href="/request-demo" className="btn-secondary">Contact Us</Link>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid-3" style={{ maxWidth: '72rem', margin: '0 auto' }}>
            {[
              ...
              },
              {
                ...
                body: 'Payment infrastructure providers and platform operators seeking to embed or connect fraud and AML intelligence capabilities within their own stack or customer-facing product offerings.',
              },
              {
                icon: (
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                body: 'Core banking, digital banking, and financial infrastructure providers whose customers — mid-market banks, credit unions, and regional institutions — face growing financial crime and compliance demands.',
              },
              {
                icon: (
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
