...
export const metadata = {
  title: 'Mule Account Detection — Verafye',
  description: 'Verafye connects signals across accounts, devices, and transaction flows to identify coordinated mule network activity earlier — enabling faster intervention and clearer escalation paths.',
  openGraph: {
    title: 'Mule Account Detection — Verafye',
    description: 'Graph-native detection that connects fraud and AML signals to surface coordinated mule networks before funds are layered.',
  },
  twitter: {
