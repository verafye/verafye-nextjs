          ...
          <div className="grid-2" style={{ maxWidth: '72rem', margin: '0 auto' }}>
            {[
              ...
              },
              {
                ...
                body: 'Without resolved entity relationships and connected case context across member accounts, devices, and transactions, credit unions do not surface the patterns that reveal coordinated fraud, mule activity, or AML exposure operating within their membership base.',
              },
              {
                gradient: 'gradient-bg-1',
            ...
            {[
              {
                ...
                body: 'Point solutions built for single domains - fraud or AML - do not surface cross-domain patterns. The boundary between fraud proceeds and money movement is precisely where coordinated financial crime operates, and where isolated systems have no visibility.',
              },
              {
                gradient: 'gradient-bg-3',
          ...
          <div style={{ maxWidth: '72rem', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', maxWidth: '56rem', margin: '0 auto 3.5rem' }}>
              ...
              <p style={{ fontSize: 'clamp(0.875rem,1.75vw,1.125rem)', color: 'var(--body)', lineHeight: 1.75 }}>
                Verafye connects fraud, AML, and payments signals from existing systems into investigation-ready workflows built on the Verafye platform - improving detection, structuring investigations, and supporting regulatory alignment. Adoption starts with a scoped pilot - agreed data feeds, defined use cases, and clean target outcomes - expanding into Verafye-led investigation workflows once outcomes are proven.
              </p>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              ...
              <div className="card" style={{ padding: '2rem' }}>
                ...
                <p style={{ fontSize: '0.875rem', color: 'var(--body)', lineHeight: 1.7, marginBottom: '1rem' }}>Graph intelligence resolves entities, maps relationships, and clusters networks across accounts, devices, and transactions - surfacing coordinated fraud rings, mule activity, and AML typologies that rules-based systems do not surface on their own.</p>
          ...
          <div className="grid-2" style={{ maxWidth: '72rem', margin: '0 auto' }}>
            {[
              ...
              },
              {
                ...
                body: 'Use graph intelligence to surface hidden links across accounts, devices, beneficiaries, transactions, and counterparties.',
              ...
              },
              {
                ...
                title: 'Lean team workflows',
                body: 'Help teams prioritize alerts, form cases, capture evidence, and close investigations faster.',
              ...
              },
              {
                ...
                title: 'Audit-ready case trails',
                body: 'Maintain decision history, notes, evidence, and audit logs for internal review and regulatory examination.',
                href: '/security-trust',
