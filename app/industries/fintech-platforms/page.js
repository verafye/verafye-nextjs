            ...
            {[
              {
                ...
                body: 'Connect users, devices, accounts, and transactions into a relationship graph  -  surfacing coordinated fraud networks, account farming rings, and synthetic identity cohorts that transaction-level detection cannot see.',
              ...
              },
              {
                ...
                body: 'Cluster related alerts and deliver pre-assembled case context  -  enabling faster triage and higher-confidence decisions without increasing analyst headcount as platform scale grows.',
              ...
              },
              {
                ...
                title: 'User and Behavioral Analysis',
                body: 'Analyse user behaviour patterns at scale  -  identifying anomalies, velocity abuse, and cross-account behavioural signals that indicate coordinated or emerging fraud schemes targeting platform incentives.',
              ...
              },
              {
                ...
                body: 'Detect account farming, referral abuse, and synthetic identity networks by connecting user, device, and transaction signals across the graph  -  surfacing coordinated schemes before they accumulate losses.',
                href: '/solutions/graph-intelligence',
                cta: 'Explore Graph Intelligence',
              },
              {
                ...
                body: 'Unify fraud scoring, device intelligence, AML monitoring, and behavioural signals into a single intelligence layer  -  eliminating the fragmentation that allows coordinated fraud to exploit gaps between systems.',
                href: '/platform',
                cta: 'View Platform',
              },
              {
                ...
                title: 'Scalable Case Management',
                body: 'Structure investigations into prioritised, context-rich cases that scale with platform growth  -  enabling risk operations teams to maintain investigation quality and throughput without proportional headcount increases.',
                href: '/solutions/investigation-intelligence',
                cta: 'Explore Investigation Intelligence',
              },
            ].map(item => (
      ...
      <section style={{ padding: '5rem 0', background: 'var(--bg-tint)', borderTop: '1px solid var(--border)' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: '48rem' }}>
          ...
          <p style={{ fontSize: 'clamp(1rem,2vw,1.125rem)', color: 'var(--body)', maxWidth: '36rem', margin: '0 auto 2.5rem' }}>
            Talk to our team about building scalable risk infrastructure for your fintech platform  -  connected intelligence that grows with your operations and remains aligned with evolving regulatory expectations.
          </p>
          <p style={{ fontSize: 'clamp(0.875rem,1.5vw,1rem)', color: 'var(--muted)', maxWidth: '34rem', margin: '0 auto 2.5rem' }}>
            BNPL, crypto, and payments platforms are investing in regulatory-aligned risk infrastructure ahead of enforcement timelines. Verafye is built to support that transition.
          </p>
