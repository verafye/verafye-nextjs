...
export const metadata = {
  title: 'Transaction Monitoring with Connected Intelligence — Verafye',
  description: 'Move beyond rule-based alerts to context-aware monitoring across transactions, entities, and behaviors.',
  openGraph: {
    title: 'Transaction Monitoring with Connected Intelligence — Verafye',
    description: 'Verafye enhances transaction monitoring by connecting signals across fraud, AML, and payments, enabling more accurate detection and better investigation workflows.',
  },
  twitter: {
