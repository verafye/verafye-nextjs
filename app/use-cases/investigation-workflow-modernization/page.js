...
export const metadata = {
  ...
  description: 'Move from fragmented workflows and manual analysis to connected, intelligence-driven investigation processes.',
  openGraph: {
    title: 'Investigation Workflow Modernization — Verafye',
    description: 'Verafye enables teams to prioritize, investigate, and resolve financial crime alerts faster through unified intelligence and workflow orchestration.',
  },
  twitter: {
      ...
      <section style={{ background: 'linear-gradient(180deg,#F8FBFF 0%,#fff 60%,#fff 100%)', overflow: 'hidden', padding: '5rem 0' }}>
        <div className="container">
          <div style={{ maxWidth: '52rem', margin: '0 auto', textAlign: 'center' }}>
            <p className="eyebrow animate-fade-up" style={{ marginBottom: '1.25rem' }}>Use Cases  -  Investigation Workflow Modernization</p>
            ...
            {[
              {
                ...
                body: 'Cluster related alerts, pre-assemble case context, and deliver structured investigation workflows that improve analyst productivity, decision consistency, and case throughput across fraud and AML operations.',
              ...
              },
              {
                ...
                body: 'Surface entity relationships, network clusters, and connection patterns at the point of investigation  -  giving analysts the graph context needed to understand coordinated risk without manual research.',
              ...
              },
              {
                ...
                body: 'Pull fraud, AML, and payments signals into a single investigation view  -  eliminating the manual platform switching that fragments analyst workflows and delays case resolution across disconnected systems.',
                href: '/platform',
                cta: 'View Platform',
              },
              {
                ...
                body: 'Score and rank investigation queues using entity context, network risk, and cross-system signals  -  ensuring analysts consistently work the highest-impact cases and backlogs are managed by risk rather than volume.',
                href: '/solutions/investigation-intelligence',
                cta: 'Explore Investigation Intelligence',
              },
              {
                ...
                body: 'Structure investigations into formal cases with consistent steps, escalation paths, disposition tracking, and audit trails  -  standardising quality across teams and supporting regulatory and governance requirements.',
                href: '/solutions/investigation-intelligence',
                cta: 'Explore Investigation Intelligence',
              },
            ].map(item => (
