      ...
      <section style={{ background: 'linear-gradient(180deg,#F8FBFF 0%,#fff 60%,#fff 100%)', overflow: 'hidden', padding: '5rem 0' }}>
        <div className="container">
          <div style={{ maxWidth: '52rem', margin: '0 auto', textAlign: 'center' }}>
            <p className="eyebrow animate-fade-up" style={{ marginBottom: '1.25rem' }}>Industries  -  Credit Unions &amp; Regional Institutions</p>
            <h1 className="animate-fade-up delay-100" style={{ fontSize: 'clamp(1.875rem,5vw,3.25rem)', fontWeight: 700, color: 'var(--dark)', marginBottom: '1.5rem', lineHeight: 1.15, letterSpacing: '-0.025em' }}>
              FRAML Intelligence Built for Credit Unions and Regional Institutions
            </h1>
            <p className="animate-fade-up delay-200" style={{ fontSize: 'clamp(1rem,2vw,1.25rem)', color: 'var(--body)', marginBottom: '1.25rem', maxWidth: '44rem', marginLeft: 'auto', marginRight: 'auto' }}>
              Credit unions and regional financial institutions face the same fraud and AML expectations as larger banks  -  without the same internal resources or infrastructure budgets.
            </p>
            <p className="animate-fade-up delay-300" style={{ fontSize: 'clamp(0.875rem,1.5vw,1rem)', color: 'var(--muted)', marginBottom: '2rem', maxWidth: '40rem', marginLeft: 'auto', marginRight: 'auto' }}>
              Verafye delivers connected fraud, AML, and investigation intelligence designed for regulatory-driven environments  -  without the implementation complexity of legacy enterprise stacks.
            </p>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '56rem', margin: '0 auto 3.5rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.375rem,3.5vw,2.75rem)', fontWeight: 700, color: 'var(--dark)', letterSpacing: '-0.025em' }}>
              The Pressure Mid-Market Institutions Face
            </h2>
          </div>
            ...
            {[
              {
                ...
                body: 'Regulators apply consistent fraud and AML expectations regardless of institution size. Credit unions and regional banks face the same monitoring, investigation, and documentation requirements as tier-one institutions  -  but with smaller compliance teams and tighter operational budgets.',
              },
              {
                ...
                body: 'Many credit unions and regional institutions operate with point solutions assembled over time  -  separate fraud detection, AML monitoring, and case management tools that do not share signals, creating blind spots and operational friction across the compliance function.',
              },
              {
          ...
          <div className="grid-2" style={{ maxWidth: '72rem', margin: '0 auto' }}>
            {[
              ...
              },
              {
                ...
                title: 'No Connected View Across Member Relationships',
                body: 'Without graph intelligence connecting accounts, devices, and transactions, institutions cannot identify the coordinated activity patterns that define modern fraud rings and mule networks operating across member portfolios.',
              },
              {
                gradient: 'gradient-bg-4',
                ...
                body: 'Tier-one enterprise fraud and AML platforms carry implementation complexity, cost, and maintenance overhead that is disproportionate for credit unions and regional institutions  -  leaving a gap between what is available and what is operationally practical.',
              },
              {
                gradient: 'gradient-bg-1',
          ...
          <div style={{ maxWidth: '72rem', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              ...
              <div className="card" style={{ padding: '2rem' }}>
                ...
                <h3 style={{ fontSize: 'clamp(0.9375rem,1.5vw,1.125rem)', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.625rem' }}>Graph-Native Detection Across Member Networks</h3>
      ...
      <section className="section-light" style={{ padding: '5rem 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '56rem', margin: '0 auto 3.5rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.375rem,3.5vw,2.75rem)', fontWeight: 700, color: 'var(--dark)', letterSpacing: '-0.025em' }}>
              Capabilities Built for Mid-Market Operations
            </h2>
          </div>
            ...
            {[
              {
                ...
                body: 'Detect hidden relationships across member accounts, devices, and transactions to surface coordinated fraud and AML risk that isolated monitoring cannot see.',
              ...
              },
              {
                ...
                body: 'Identify coordinated mule account networks operating within the membership base by connecting account, device, identity, and behavioural signals across the full graph.',
              ...
              },
              {
                ...
                title: 'Case Management and Audit Trails',
      ...
      <section style={{ padding: '5rem 0', background: '#fff' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '56rem', margin: '0 auto 3.5rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.375rem,3.5vw,2.75rem)', fontWeight: 700, color: 'var(--dark)', letterSpacing: '-0.025em' }}>
              Outcomes for Credit Unions and Regional Institutions
            </h2>
          </div>
          <div className="grid-2" style={{ maxWidth: '72rem', margin: '0 auto' }}>
            {[
      ...
      <section style={{ padding: '5rem 0', background: 'var(--bg-tint)', borderTop: '1px solid var(--border)' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: '48rem' }}>
          ...
          <p style={{ fontSize: 'clamp(1rem,2vw,1.125rem)', color: 'var(--body)', maxWidth: '36rem', margin: '0 auto 1.25rem' }}>
            Talk to our team about bringing connected fraud, AML, and investigation intelligence to your institution  -  without the complexity of a large enterprise implementation.
          </p>
          <p style={{ fontSize: 'clamp(0.875rem,1.5vw,1rem)', color: 'var(--muted)', maxWidth: '34rem', margin: '0 auto 2.5rem' }}>
            Credit unions and regional institutions are investing in regulatory-aligned financial crime infrastructure ahead of examiner review cycles. Verafye is designed to support that transition.
          </p>
