  ...
  return (
    <>
      ...
      <div
        className={[
          'request-demo-toast',
          toast ? 'request-demo-toast--show' : '',
          toast ? `request-demo-toast--${toast.type}` : '',
        ].filter(Boolean).join(' ')}
        role="alert"
        aria-live="assertive"
        aria-atomic="true"
        ...
        {toast && (
          <>
            <div className="request-demo-toast__header">
              ...
              <button
                type="button"
                className="request-demo-toast__close"
            ...
            <div className="request-demo-toast__body">
              {toast.message}
            </div>
          </>
        )}
                ...
                {submitted ? (
                  <div style={{ textAlign: 'center', padding: '2rem 0' }}>
                    ...
                    <p style={{ fontSize: '0.9375rem', color: 'var(--body)', lineHeight: 1.7, marginBottom: '1.5rem', maxWidth: '22rem', marginLeft: 'auto', marginRight: 'auto' }}>
                      We'll reach out to schedule a session aligned to your use case.
                    </p>
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                      ...
                      <p style={{ fontSize: '0.75rem', color: 'var(--muted-light)', textAlign: 'center', marginTop: '1rem', lineHeight: 1.6 }}>
                        By submitting this form you agree to be contacted by the Verafye team regarding your request.
                      </p>
                    </form>
                  </>
                )}
